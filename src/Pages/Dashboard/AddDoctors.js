...
const AddDoctors = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://pacific-badlands-31165.herokuapp.com/service').then(res => res.json()))
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://pacific-badlands-31165.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
